...
// #endif
    ...
    GSCALAR(vtx_cli0_channel, "VTX_CLI0_CHAN", 0),
    ...
    GSCALAR(vtx_cli1_channel, "VTX_CLI1_CHAN", 0),
    ...
    GSCALAR(vtx_cli2_channel, "VTX_CLI2_CHAN", 0),
    ...
    GSCALAR(vtx_cli3_channel, "VTX_CLI3_CHAN", 0),
    ...
    GSCALAR(vtx_cli4_channel, "VTX_CLI4_CHAN", 0),
    ...
    GSCALAR(vtx_cli5_channel, "VTX_CLI5_CHAN", 0),
    ...
    GSCALAR(vtx_cli6_channel, "VTX_CLI6_CHAN", 0),
    ...
    GSCALAR(vtx_cli7_channel, "VTX_CLI7_CHAN", 0),
